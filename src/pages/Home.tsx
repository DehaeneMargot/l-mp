                ...
                <section className="min-h-screen overflow-hidden">
                    <div className=" grid lg:grid-cols-2 md:p-6 h-screen">
                        <div className="p-4 lg:p-0 absolute lg:relative bottom-6 my-auto z-20">
                            ...
                            <Link replace to="/lamps?type=all_lamps"><p  className="bg-orange-500 hover:bg-orange-400 text-white px-6 py-3 rounded-md font-semibold w-max mt-10" >Discover lamps</p></Link>
                        </div>
